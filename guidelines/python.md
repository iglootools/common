...
- **Python Version**: 3.12 floor, 3.14 for local development — write nothing that needs a
  feature newer than 3.12. The knobs that enforce it are in
  [project-setup/python-tooling.md](project-setup/python-tooling.md#python-version-policy).
- **Control Flow**
...
- **Console Output**: print through [Rich](https://github.com/textualize/rich), which
  ...
  `Console Output` rule in [coding.md](coding.md).
